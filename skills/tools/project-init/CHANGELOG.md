...
- **法律文档项目：** 用 legal-ocr 替代 mineru-ocr + paddle-ocr；新增 pdf-processor、pdf-organizer、img2pdf、案例库-law-search
- **移除 private-skills 和 myagents 技能源**，仅保留 技能集合
...
- **CLAUDE.md 生成指南：** 6 种项目类型的段落定义、结构模板和脱敏范例（simple / development / frontend / comprehensive-development / data-analysis / skill-project），通过 `@include 用户技能目录/CLAUDE.md` 引入全局协议
