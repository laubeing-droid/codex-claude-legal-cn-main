...
**阅读披露前，先读取 `本地配置目录 如缺失或仍含占位符，停止并运行 `/ip-legal:cold-start-interview`。实务画像告诉你：
...
> **《中华人民共和国专利法》第25条的标准与。** 中国的可授权主题排除清单（《中华人民共和国专利法》第25条 `[法条原文]`）与。中国明确排除科学发现、智力活动的规则和方法、疾病的诊断和治疗方法、动物和植物品种、原子核变换方法获得的物质，但对于软件和商业方法的审查实践有其自身特点。
