...
> 本技能适用的到期日规则反映截至本技能构建日的公开要求。知识产权局要求、宽限期、费用结构和维持费标准会变化。**始终在行动前与国家知识产权局商标查询系统/专利公布公告系统、WIPO马德里监控/专利查询、。**
>
...
- **中国商标：** 注册商标有效期十年，自核准注册之日起计算（《中华人民共和国商标法》第39条 `[法条原文]`）。续展注册应在期满前十二个月内办理，宽展期为六个月（《中华人民共和国商标法》第40条 `[法条原文]`）。宽展期内续展需缴纳迟延费。
 - **商标使用义务：** 注册商标连续三年不使用，任何单位或个人可向国家知识产权局申请撤销（《中华人民共和国商标法》第49条 `[法条原文]`，俗称"撤三"）。不同于，而是被动撤三制度。保留使用证据对于防御撤三至关重要。
- **马德里国际商标：** 十年注册期，可在WIPO续展；个别指定国可能有本地使用或声明要求（如。
- **。
