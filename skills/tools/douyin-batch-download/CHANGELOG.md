...
open /Users/maoking/Library/Application\\ Support/maoscripts/skills/技能集合/test/douyin-batch-download/downloads/index.html
```
...
```bash
# 启动本地 Web 服务器
cd /Users/maoking/Library/Application\ Support/maoscripts/skills/技能集合/test/douyin-batch-download
